...
const HeroSection = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="AUTODEBATE - Automotive Content Creation" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          {/* Badge */}
          <Link to={user ? "/comunidad" : "/auth"} className="inline-flex items-center bg-primary-light border border-primary/20 rounded-full px-6 py-2 mb-8 animate-fade-in hover:bg-primary/10 transition-colors">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-scale-in">
            <Button variant="hero" size="lg" className="text-lg px-8 py-4" asChild>
              <a href="https://www.youtube.com/@autodebate" target="_blank" rel="noopener noreferrer">
                <Play className="w-5 h-5 mr-2" />
                {t('hero.watch')}
              </a>
            </Button>
            <Button variant="platform" size="lg" className="text-lg px-8 py-4" asChild>
              <Link to="/galeria">
